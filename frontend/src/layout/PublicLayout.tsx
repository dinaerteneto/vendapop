          ...
          .then(response => {
            ...
            response.data.forEach((t: { provider: string; tracking_code: string }) => {
              ...
              if (t.provider === 'google_analytics') {
                ...
                gtagScript.text = `window.dataLayer=window.dataLayer||[];if(typeof gtag !== 'function'){function gtag(){dataLayer.push(arguments);}}gtag('js',new Date());gtag('config','${t.tracking_code}');`;
