...
const sections: LegalSection[] = [
  {
    ...
    content: (
      <>
        <p>
          Esta Política de Privacidade descreve como o <strong>VesteZap</strong> ("nós", "nosso" ou "plataforma") coleta, usa, armazena e protege seus dados pessoais em conformidade com a Lei Geral de Proteção de Dados Pessoais (LGPD - Lei nº 13.709/2018).
        </p>
        <p>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          O controlador dos seus dados pessoais é o <strong>VesteZap</strong>.
        </p>
        <p>
          Para dúvidas sobre proteção de dados ou para exercer seus direitos, entre em contato através do e-mail: <strong>privacidade@vestezap.com.br</strong>
        </p>
      </>
    ),
  },
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="mt-4">
          Para exercer seus direitos, entre em contato através de: <strong>privacidade@vestezap.com.br</strong>
        </p>
        <p>
